...
public class ProfileMerger {
    ...
    private static void updatePDFUAProfiles(ZipFile zipSource) {
        ...
        generateProfile(zipSource, "WCAG-22.xml", PDFUA_FOLDER, new String[]{"WCAG/2.2"}, new String[]{}, Collections.emptyList());
        ...
        generateProfile(zipSource, "WCAG-22-Complete.xml", PDFUA_FOLDER, new String[]{"WCAG/2.2", "WCAG/PDF_UA", "1"}, new String[]{}, excludedWCAGRules);
        generateProfile(zipSource, "WCAG-22-Machine.xml", PDFUA_FOLDER, new String[]{"WCAG/2.2", "WCAG/PDF_UA", "1"}, new String[]{}, excludedWCAGRules);
    }
