...
public class ProfileMerger {
    ...
    private static void updatePDFUAProfiles(ZipFile zipSource) {
        ...
        excludedTaggedRules.add(Profiles.ruleIdFromValues(PDFAFlavour.Specification.ISO_32005, "7.2", 1));
        excludedTaggedRules.add(Profiles.ruleIdFromValues(PDFAFlavour.Specification.ISO_32005, "7.2", 2));
        excludedTaggedRules.add(Profiles.ruleIdFromValues(PDFAFlavour.Specification.ISO_32005, "7.2", 3));
        ...
        List<RuleId> excludedWCAGRules = new ArrayList<>(10);
        ...
        excludedWCAGRules.add(Profiles.ruleIdFromValues(PDFAFlavour.Specification.ISO_14289_1, "6.1", 1));
